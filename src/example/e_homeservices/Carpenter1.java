...
public class Carpenter1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_carpenter1);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.carpenter1, menu);
		...
		Continue.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
	           ...
	           Intent intent = new Intent(Carpenter1.this,SendService.class);
	           intent.putExtra("user", Carpenter1.this.getTitle().toString());
