...
public class Electrical2 extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.electrical2, menu);
		...
		Continue.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
	           ...
	           Intent intent = new Intent(Electrical2.this,SendService.class);
	           intent.putExtra("user", Electrical2.this.getTitle().toString());
